...
def consolidate_location(dict_adm1, dict_adm2, dict_adm3, level=3):
    adm1_str = ''
    adm2_str = ''
    adm3_str = ''
...
if __name__ == "__main__":
    ...
    for index, row in df_data.iterrows():
        ...
        adm1_str, adm2_str, adm3_str =\
            consolidate_location(dict_adm1, dict_adm2, dict_adm3, 1)
    ...
    f_out = f_in.replace('.xlsx', '_normal_2.xlsx')
